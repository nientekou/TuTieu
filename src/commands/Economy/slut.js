...
function resolveOutcome(activity, wallet) {
    ...
    if (remainingAfterSuccess < fineChance + robbedChance) {
        ...
        return {
            ...
            title: `${activity.name} - Lòng Người Hiểm Ác`
        };
    }
...
export default {
    data: new SlashCommandBuilder()
        .setName('slut')
        .setDescription('Nhận một ủy thác'),
