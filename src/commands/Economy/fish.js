...
const FISH_TYPES = [
    ...
    { name: 'Ngân Sa Ngư', emoji: ':fish:', rarity: 'Phàm' },
    { name: 'Hồng Vĩ Ngư', emoji: ':fish:', rarity: 'Phàm' },
    { name: 'Lam Văn Ngư', emoji: ':fish:', rarity: 'Phàm' },
    { name: 'Thạch Giáp Giải', emoji: ':crab:', rarity: 'Phàm' },
    { name: 'Thanh Xà Hà', emoji: ':shrimp:', rarity: 'Phàm' },
    { name: 'Bích Hải Loa', emoji: ':shell:', rarity: 'Phàm' },
    { name: 'Tử Hải Tảo', emoji: ':herb:', rarity: 'Phàm' },
    { name: 'Linh Bối', emoji: ':shell:', rarity: 'Phàm' },

    // Linh
    { name: 'Xích Lân Ngư', emoji: ':tropical_fish:', rarity: 'Linh' },
    { name: 'Kim Vĩ Ngư', emoji: ':tropical_fish:', rarity: 'Linh' },
    { name: 'Hàn Tuyền Ngư', emoji: ':fish:', rarity: 'Linh' },
    { name: 'Bích Ba Ngư', emoji: ':fish:', rarity: 'Linh' },
    { name: 'Tử Vân Ngư', emoji: ':fish:', rarity: 'Linh' },
    { name: 'Ngân Nguyệt Ngư', emoji: ':tropical_fish:', rarity: 'Linh' },
    { name: 'Huyền Giáp Giải', emoji: ':crab:', rarity: 'Linh' },
    { name: 'Kim Tu Hà', emoji: ':shrimp:', rarity: 'Linh' },
    { name: 'Linh Châu Bối', emoji: ':shell:', rarity: 'Linh' },
    { name: 'Hải Linh Sâm', emoji: ':coral:', rarity: 'Linh' },

    // Huyền
    { name: 'Ngọc Lân Ngư', emoji: ':tropical_fish:', rarity: 'Huyền' },
    { name: 'Thanh Minh Ngư', emoji: ':fish:', rarity: 'Huyền' },
    { name: 'Lưu Vân Ngư', emoji: ':fish:', rarity: 'Huyền' },
    { name: 'Huyền Băng Ngư', emoji: ':fish:', rarity: 'Huyền' },
    { name: 'Tử Điện Ngư', emoji: ':tropical_fish:', rarity: 'Huyền' },
    { name: 'Kim Lân Giải', emoji: ':crab:', rarity: 'Huyền' },
    { name: 'Huyền Tinh Hà', emoji: ':shrimp:', rarity: 'Huyền' },
    { name: 'Bích Ngọc Bối', emoji: ':shell:', rarity: 'Huyền' },
    { name: 'Hải Nguyệt Châu', emoji: ':oyster:', rarity: 'Huyền' },
    { name: 'Cửu Tiết Hải Sâm', emoji: ':coral:', rarity: 'Huyền' },
    { name: 'Mặc Hải Tu', emoji: ':octopus:', rarity: 'Huyền' },

    // Địa
    { name: 'Thiên Hà Linh Ngư', emoji: ':tropical_fish:', rarity: 'Địa' },
    { name: 'Cửu Vân Ngư', emoji: ':fish:', rarity: 'Địa' },
    { name: 'Huyền Lôi Ngư', emoji: ':tropical_fish:', rarity: 'Địa' },
    { name: 'Bích Hải Long Ngư', emoji: ':dragon_face:', rarity: 'Địa' },
    { name: 'Tử Kim Lân', emoji: ':fish:', rarity: 'Địa' },
    { name: 'Huyền Giáp Hải Quy', emoji: ':turtle:', rarity: 'Địa' },
    { name: 'Ngân Nguyệt Cự Giải', emoji: ':crab:', rarity: 'Địa' },
    { name: 'U Minh Hải Tu', emoji: ':octopus:', rarity: 'Địa' },
    { name: 'Xích Viêm Hải Xà', emoji: ':snake:', rarity: 'Địa' },
    { name: 'Linh Châu Hải Bối', emoji: ':oyster:', rarity: 'Địa' },

    // Thiên
    { name: 'Thái Hư Kình', emoji: ':whale2:', rarity: 'Thiên' },
    { name: 'Cửu Thiên Hải Long', emoji: ':dragon_face:', rarity: 'Thiên' },
    { name: 'Huyền Minh Cự Ngư', emoji: ':whale2:', rarity: 'Thiên' },
    { name: 'Vạn Tượng Linh Ngư', emoji: ':tropical_fish:', rarity: 'Thiên' },
    { name: 'Thương Hải Kình', emoji: ':whale2:', rarity: 'Thiên' },
    { name: 'Kim Lân Hải Hoàng', emoji: ':dragon_face:', rarity: 'Thiên' },
    { name: 'Tử Tiêu Lôi Kình', emoji: ':whale2:', rarity: 'Thiên' },
    { name: 'Cửu U Hải Xà', emoji: ':snake:', rarity: 'Thiên' },
];
